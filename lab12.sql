...
GRANT RESTRICTED SESSION TO VYDRA_DBA;
GRANT CREATE ANY TABLE TO VYDRA_DBA;
GRANT CREATE ANY VIEW TO VYDRA_DBA;
GRANT CREATE SEQUENCE TO VYDRA_DBA;
GRANT UNLIMITED TABLESPACE TO VYDRA_DBA;
GRANT CREATE CLUSTER TO VYDRA_DBA;
GRANT CREATE SYNONYM TO VYDRA_DBA;
GRANT CREATE PUBLIC SYNONYM TO VYDRA_DBA;
GRANT CREATE MATERIALIZED VIEW TO VYDRA_DBA;
GRANT CREATE ANY PROCEDURE TO VYDRA_DBA; -- из 10 лабы
GRANT CREATE TYPE TO VYDRA_DBA; -- из 10 лабы


GRANT CREATE TRIGGER TO VYDRA_DBA; -- нужно для этой лабы
...
INSERT INTO STUDENT (STUDENT, STUDENT_NAME, PULPIT)
VALUES ('S012', 'Макаров рлексей', 'ИСиТ');
...
INSERT INTO STUDENT (STUDENT, STUDENT_NAME, PULPIT)
VALUES ('S013', 'Макаров клексей', 'ИСиТ');
...
-- оставить только триггеры из 3, 7 и 8 задания
...
select * from DBA_TRIGGERS where OWNER = 'VYDRA_DBA'; -- от коннекта SYS
select * from AUDIT_LOG;
...
create or replace trigger BEFORE_DROP
  before drop on VYDRA_DBA.SCHEMA
begin
